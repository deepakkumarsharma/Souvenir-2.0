        ...
        <div class="s_data shrink">
            <div class="content id_first-slide-text">
            	...
            	<form class="performa" method="post" accept-charset="utf-8" action="<?php echo base_url();?>index.php/form">
					...
					<!-- Date Of Birth -->
					<input type="text" id="datepicker" ng-model="dob" class="dob" name="DOB" pattern="\d{1,2}/\d{1,2}/\d{4}" title="Number Only, Like: 6/2/2000" placeholder="D.O.B : 25/2/2000" required  />
					<script>
						// $(function() {
					...
					<input type="textarea" ng-model="address" class="address" name="Address"  pattern="[a-zA-Z\s]+" title="Characters Only." placeholder="Address"  required /><br>
					<!-- Image -->
					<h2 class="name">Upload Photo</h2><br>
					
					<input id="uploadImage" class="uploadImage" ng-model="image" type="file" name="userfile" onchange="PreviewImage();" size="20" required /><br>
